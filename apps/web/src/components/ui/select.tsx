    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          style={{
            width: alignItemWithTrigger ? "var(--anchor-width)" : undefined,
            minWidth: alignItemWithTrigger ? "var(--anchor-width)" : undefined,
            ...style,
          }}
          {...props}
        >
