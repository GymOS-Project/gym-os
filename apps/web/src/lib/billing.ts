...
export const BILLING_PLANS = {
  starter: {
    ...
    yearlyPrice: 7000,
    tagline:
      'Everything a single gym needs to run daily operations with confidence.',
    featuredBullets: [
  ...
  growth: {
    ...
    yearlyPrice: 12990,
    tagline:
      'For high-volume single gyms that need classes, PT, coupons, and sharper insights.',
    featuredBullets: [
  ...
  scale: {
    ...
    yearlyPrice: 24990,
    tagline:
      'For multi-branch businesses that want biometric attendance, payroll, and audit control.',
    featuredBullets: [
